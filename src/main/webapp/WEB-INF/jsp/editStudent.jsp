    ...
    <div class="container studentForm">
        ...
        <form action="student" method="post">
            <div class="form-group row">
                <label for="id" class="col-xs-3 col-form-label mr-2">Student ID:</label>
                <div class="col-xs-9">
                    <input type="text" class="form-control" value="${student.id}" name="id" disabled>
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                <div class="offset-xs-3 col-xs-9">
                    <button type="submit" name="updateStudent" id="submit">Update</button>
                </div>
            </div>
        </form>
    </div>
