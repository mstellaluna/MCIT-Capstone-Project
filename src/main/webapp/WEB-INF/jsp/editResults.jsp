...
<body>
   ...
   <div class="container resultsForm">
            ...
            <form action="results" method="post">
                ...
                <label for="studentId" class="col-xs-3 col-form-label mr-2">Student ID:</label>
                <div class="col-xs-9">
                <input type="text" class="form-control" value="${results.student.id}" name="studentId" disabled>
                </div>
                </div>
                <div class="form-group row">
                <label for="courseId" class="col-xs-3 col-form-label mr-2">Course ID:</label>
                <div class="col-xs-9">
                <input type="text" class="form-control" value="${results.course.id}" name="courseId" disabled>
                </div>
                </div>
                <div class="form-group row">
                <label for="marks1" class="col-xs-3 col-form-label mr-2">Marks 1:</label>
                <div class="col-xs-9">
                <input type="text" class="form-control" id="marks1" name="marks1">
                </div>
                </div>
                <div class="form-group row">
                <label for="marks2" class="col-xs-3 col-form-label mr-2">Marks 2:</label>
                <div class="col-xs-9">
                ...
                <div class="offset-xs-3 col-xs-9">
                        <button type="submit" name="updateResults" id="submit">Update</button>
